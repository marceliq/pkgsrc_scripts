...
PKGSRC_MODULES="devel/py-ipython_genutils www/py-notebook devel/py-pip"
...
VERSION=`$PREFIX/bin/pip3.8 search Glances |perl -nle "print if m/^Glances\ \([0-9]/" |${AWK} -F '[()]' '{print $2}'` || exit 1
echo $VERSION
