...
PKGSRC_MODULES="misc/screen devel/py-pip devel/py-readline devel/py-curses /devel/py-cursespanel databases/py-elasticsearch databases/py-redis databases/py-sqlite3 devel/py-mako sysutils/py-kazoo time/py-dateutil security/py-m2crypto security/gnupg2 sysutils/py-Glances"
