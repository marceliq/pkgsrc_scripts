...
PKGSRC_MODULES="security/mozilla-rootcerts-openssl lang/py-six misc/screen4 sysutils/monit devel/py-pip databases/py-redis devel/py-kafka-python devel/py-mako sysutils/py-kazoo time/py-dateutil textproc/py-toml misc/py-immutables time/py-timelib time/py-pytz rb/py-backports.tarfile"
